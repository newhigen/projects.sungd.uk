...
shots:
  - src: "/p/worklog-dashboard/worklog-v1.png"
    label: "다크로 시작"
    note: "다크 테마로 출발 — 일단 보이게"
  - src: "/p/worklog-dashboard/worklog-v2.png"
    label: "히트맵 추가"
    note: "연간 히트맵을 더해 — 시기 패턴이 보이게"
  - src: "/p/worklog-dashboard/worklog-v3.png"
    label: "색 규칙 · 완성"
    note: "야근에 색 규칙 — 한눈에 강조되게"
---
## 문제
