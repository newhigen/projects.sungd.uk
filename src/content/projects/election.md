...
use:
  ...
  - "출처 호버 툴팁으로 근거를 확인한다"
shots:
  - src: "/p/election/election-v1.png"
    label: "후보 카드"
    note: "정보를 늘어놓았지만 \"누가 나은가\"엔 답을 못 했다"
  - src: "/p/election/election-v2.png"
    label: "분석 깊이"
    note: "비교·이행 실적·분야별로 — 늘어놓기를 비교 도구로"
  - src: "/p/election/election-v3.png"
    label: "톤 입히기"
    note: "polished 미학으로 — 정보가 차분히 읽히게"
---
## 문제
